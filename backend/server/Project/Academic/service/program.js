...
exports.onQuery = async function (request, response) {
    try {
        ...
        const doc = await Program.onQuery(query);
...
exports.onQuerys = async function (request, response) {
    try {
        let query = {};
        const doc = await Program.onQuerys(query);
        return ResMessage.sendResponse(response, 0, 20000, doc);
    } catch (err) {
        return ResMessage.sendResponse(response, 0, 40400);
    }
...
exports.onCreate = async function (request, response) {
    try {
        ...
        const doc = await Program.onCreate(request.body);
        return ResMessage.sendResponse(response, 0, 20000, doc);
    } catch (err) {
        console.log(err);
        return ResMessage.sendResponse(response, 0, 40400);
...
exports.onUpdate = async function (request, response) {
    try {
        ...
        const doc = await Program.onUpdate(query, request.body);
        return ResMessage.sendResponse(response, 0, 20000, doc);
    } catch (err) {
        console.error(err);
        return ResMessage.sendResponse(response, 0, 40400);
...
exports.onDelete = async function (request, response) {
    try {
        let query = {};
        query._id = new mongo.ObjectId(request.body._id);
        const doc = await Program.onDelete(query);
        return ResMessage.sendResponse(response, 0, 20000, doc);
    } catch (err) {
        return ResMessage.sendResponse(response, 0, 40400);
    }
