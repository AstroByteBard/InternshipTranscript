    ...
    <CRow>
      <CCol sm="12">
        <CCard>
          ...
          <!-- Filter Section -->
          <StudentFilter :schools="schools" :majors="majors" :courses="courses" @filter="onFilter" />
          <CCardBody>
            <CTableWrapper :items="filteredStudents" :fields="studentFields" :loading="isLoading" hover striped bordered
              small fixed caption="StudentTable">
