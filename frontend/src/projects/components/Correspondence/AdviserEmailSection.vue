<template>
    <div>
                        ...
                        <CCol>
                            <CCard class="table-card border-0 shadow-sm mb-4">
                                <div class="table-scroll">
                                    <CDataTable class="custom-table mb-0" :items="advisersTable"
        ...
        <ModalEmailTemplateAdviser ref="modalTemplate" @refresh="loadData" />
    </div>
</template>
    ...
    computed: {
        ...
        translatedFields() {
            ...
            return this.fields.map(field => {
                ...
                let label = field.key.toUpperCase()
        ...
        advisersTable() {
            ...
            if (this.searchQuery.trim()) {
                ...
                source = source.filter(adviser => {
                    ...
                    return advName.includes(q) || stuName.includes(q)
                })
            }
        ...
        totalPages() { return Math.ceil(this.advisersTable.length / this.itemsPerPage) || 1 },
        tableStartItem() { return this.advisersTable.length === 0 ? 0 : (this.activePage - 1) * this.itemsPerPage + 1 },
        tableEndItem() { return Math.min(this.activePage * this.itemsPerPage, this.advisersTable.length) },
    },
}
</script>
