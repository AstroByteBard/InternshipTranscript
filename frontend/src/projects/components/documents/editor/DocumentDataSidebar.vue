...
<script>
import SharedVariableList from './SharedVariableList.vue';

export default {
    name: 'DocumentDataSidebar',
    components: {
        SharedVariableList
    },
    methods: {
        onSelect(value) {
            this.$emit('insert-variable', value);
        }
    }
}
</script>
...
<style scoped>
/* Scoped styles are now managed in SharedVariableList.vue */
</style>
