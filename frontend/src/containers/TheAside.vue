<template>
  <CSidebar aside :show="$store.state.asideShow" @update:show="(val) => $store.commit('set', ['asideShow', val])"
    colorScheme="light" overlaid size="lg">
    ...
    <CTabs tabs class="nav-underline nav-underline-primary">
      <CTab active>
        ...
        <CListGroup class="list-group-accent">
          <CListGroupItem class="list-group-item-accent-secondary bg-light text-center 
          ...
          <CListGroupItem href="#" class="list-group-item-accent-warning list-group-item-divider">
            <div class="c-avatar float-right">
              <img class="c-avatar-img" src="img/avatars/7.jpg" alt="admin@bootstrapmaster.com">
            </div>
            <div>{{ $t('meeting_with') }}
              <strong>Lucas</strong>
            </div>
          ...
          <CListGroupItem href="#" class="list-group-item-accent-info">
            <div class="c-avatar float-right">
              <img class="c-avatar-img" src="img/avatars/4.jpg" alt="admin@bootstrapmaster.com">
            </div>
          ...
          <CListGroupItem href="#" class="list-group-item-accent-danger list-group-item-divider">
            <div>{{ $t('new_ui_project') }} <strong>{{ $t('deadline') }}</strong>
            </div>
            <small class="text-muted mr-3">
            ...
            <div class="c-avatars-stack mt-2">
              <div class="c-avatar c-avatar-xs">
                <img class="c-avatar-img" src="img/avatars/2.jpg" alt="admin@bootstrapmaster.com">
              </div>
              <div class="c-avatar c-avatar-xs">
                <img class="c-avatar-img" src="img/avatars/3.jpg" alt="admin@bootstrapmaster.com">
              </div>
              <div class="c-avatar c-avatar-xs">
                <img class="c-avatar-img" src="img/avatars/4.jpg" alt="admin@bootstrapmaster.com">
              </div>
              <div class="c-avatar c-avatar-xs">
                <img class="c-avatar-img" src="img/avatars/5.jpg" alt="admin@bootstrapmaster.com">
              </div>
              <div class="c-avatar c-avatar-xs">
                <img class="c-avatar-img" src="img/avatars/6.jpg" alt="admin@bootstrapmaster.com">
              </div>
            </div>
          </CListGroupItem>
          <CListGroupItem href="#" class="list-group-item-accent-success list-group-item-divider">
            <div><strong>#10 Startups.Garden</strong> {{ $t('meetup') }}</div>
            <small class="text-muted mr-3">
              <CIcon name="cil-calendar" />&nbsp; 1 - 3pm
            </small>
            <small class="text-muted">
          ...
          <CListGroupItem href="#" class="list-group-item-accent-primary list-group-item-divider">
            <div><strong>{{ $t('team_meeting') }}</strong></div>
            <small class="text-muted mr-3">
            ...
            <div class="c-avatars-stack mt-2">
              <div class="c-avatar c-avatar-xs">
                <img src="img/avatars/2.jpg" class="c-avatar-img" alt="admin@bootstrapmaster.com">
              </div>
              <div class="c-avatar c-avatar-xs">
                <img src="img/avatars/3.jpg" class="c-avatar-img" alt="admin@bootstrapmaster.com">
              </div>
              <div class="c-avatar c-avatar-xs">
        ...
        <div class="p-3">
          ...
          <div>
            <div class="clearfix mt-4">
              ...
              <CSwitch color="success" labelOn="On" labelOff="Off" shape="pill" size="sm" class="float-right" checked />
            </div>
            <div>
              <small class="text-muted">
          ...
          <div>
            <div class="clearfix mt-3">
              ...
              <CSwitch color="success" labelOn="On" labelOff="Off" shape="pill" size="sm" class="float-right" />
            </div>
            <div>
              <small class="text-muted">{{ lorem }}</small>
            </div>
          ...
          <div>
            <div class="clearfix mt-3">
              ...
              <CSwitch color="success" labelOn="On" labelOff="Off" shape="pill" size="sm" class="float-right" disabled
                checked />
            </div>
            <div>
