    ...
    <CHeader with-subheader class="bg-white border-bottom custom-header-container">
        <div class="d-flex align-items-center w-100 pr-4 custom-header-height">
            ...
            <div class="d-flex align-items-center right-actions-group">
                ...
                <!-- Language Selector -->
                <div class="lang-selector-btn d-flex align-items-center justify-content-center mr-4"
                    @click="onSwitchLang">
                ...
                <!-- User Dropdown (TheHeaderDropdownStudent) -->
                <TheHeaderDropdownStudent />
            </div>
        </div>
    </CHeader>
</template>
...
<script>
import TheHeaderDropdownStudent from './TheHeaderDropdownStudent'
import { mapGetters } from "vuex";

export default {
    name: 'TheHeader_Student',
    components: {
        TheHeaderDropdownStudent,
    },
    computed: {
